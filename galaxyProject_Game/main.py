import os
# to ensure that the kiby works well
os.environ['KIVY_GL_BACKEND'] = 'angle_sdl2'
# setting a configuration for the kivy window app
...
class MainWidget(RelativeLayout):
    from transformGalaxy import transform, transform_perspective, transform_2D
    ...
    def init__audio(self):
        ...
        # setting the volume of the galaxy
    ...
    def check_ship_collision(self):
        for i in range(0, len(self.tiles_coordinates)):
            ...
            if ti_y > self.current_y_loop + 1:
                return False
            if self.check_ship_colllision_with_tile(ti_x, ti_y):
                return True
        return False



    def check_ship_colllision_with_tile(self, ti_x, ti_y):
    ...
    def update(self,dt):
        ...
        if not self.check_ship_collision() and not self.state_game_over :
            ...
            # to delay the call of the game over voice
